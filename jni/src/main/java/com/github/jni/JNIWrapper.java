...
public class JNIWrapper {
	...
	static {
		...
		//   java.library.path=/path/to/shapefile_jniwrapper.dll
        //System.loadLibrary("shapefile_jniwrapper");
		...
		if (osName.indexOf("Windows") != -1) {
			...
			System.load(JNIWrapper.concatPaths(jniLibsPrefix, "libshapefile_dll.dll"));
			System.load(JNIWrapper.concatPaths(jniLibsPrefix, "shapefile_jniwrapper.dll"));
